...
func RegisterNoteV1Server(s *grpc.Server, srv NoteV1Server) {
	s.RegisterService(&_NoteV1_serviceDesc, srv)
}
...
var _NoteV1_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/note_v1/note.proto",
}
